...
const GenerateSignature = (payLoad) => {
    return jsonwebtoken_1.default.sign(payLoad, configs_1.APP_SECRET, { expiresIn: '1d' }); // can be modified
};
exports.GenerateSignature = GenerateSignature;
const validateSignature = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const signature = req.get('Authorization');
    if (signature) {
        const payLoad = yield jsonwebtoken_1.default.verify(signature.split(' ')[1], configs_1.APP_SECRET);
        req.user = payLoad;
        return true;
    }
    return false;
